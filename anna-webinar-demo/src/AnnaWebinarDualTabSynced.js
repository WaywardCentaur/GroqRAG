...
const AnnaWebinarDualTab = () => {
  ...
  const startVideo = useCallback(() => {
    ...
    // Automatically open player tab when video starts for audio capture
    setTimeout(() => {
      ...
      <WebinarWrapper>
        ...
        <VideoSection>
          <VideoPlayer>
            ...
            {playing && (
              <>
                {/* Embedded YouTube video in main tab */}
                <VideoIframe
                  id="main-youtube-player"
                  src={`https://www.youtube.com/embed/${WEBINAR_VIDEO_ID}?enablejsapi=1&autoplay=1&controls=1&iv_load_policy=3&modestbranding=1&rel=0&fs=1&playsinline=1&start=0&origin=${encodeURIComponent(window.location.origin)}&t=${Date.now()}`}
                ...
                <VideoControls>
                  ...
                  <span>•</span>
                  <span>📱 Player tab: Audio capture</span>
                </VideoControls>
